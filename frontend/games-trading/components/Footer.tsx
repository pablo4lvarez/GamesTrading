  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      ...
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a className='btn btn-ghost normal-case' href="https://github.com/pablo4lvarez/GamesTrading" target="_blank" rel="noopener noreferrer">
          <img
            src="/github-mark-white.svg"  // Replace with the actual path to your GitHub logo
            alt="GitHub Logo"
